...
export interface ApiJobApplicationJobApplication
  ...
  attributes: {
    ...
    phoneNumber: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.CustomField<'plugin::strapi-phone-validator.phone'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface PluginEntityNotesNote extends Struct.CollectionTypeSchema {
...
export interface PluginGraphsBuilderGraph extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    collectionX: Schema.Attribute.String & Schema.Attribute.Required;
    collectionXAttribute: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    type: Schema.Attribute.Enumeration<['pie', 'bar', 'line', 'dateLine']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
