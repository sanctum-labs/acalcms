...
export interface HomePageMalawi {
  id: number;
  attributes: {
...
export interface HomePageMalawi_Plain {
  id: number;
...
export interface HomePageMalawi_NoRelations {
  id: number;
...
export interface HomePageMalawi_AdminPanelLifeCycle {
  id: number;
  createdAt: Date;  updatedAt: Date;  publishedAt?: Date;  Hero?: Hero_Plain;
  Overview?: Overview_Plain;
  JoinTheTeam: Card_Plain[];
