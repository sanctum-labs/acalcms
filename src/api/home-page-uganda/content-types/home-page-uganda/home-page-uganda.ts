...
export interface HomePageUganda {
  id: number;
  attributes: {
...
export interface HomePageUganda_Plain {
  id: number;
...
export interface HomePageUganda_NoRelations {
  id: number;
...
export interface HomePageUganda_AdminPanelLifeCycle {
  id: number;
  createdAt: Date;  updatedAt: Date;  publishedAt?: Date;  Hero?: Hero_Plain;
  Overview?: Overview_Plain;
  JoinTheTeam: Card_Plain[];
