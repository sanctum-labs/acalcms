...
export interface HomePageRwanda {
  id: number;
  attributes: {
...
export interface HomePageRwanda_Plain {
  id: number;
...
export interface HomePageRwanda_NoRelations {
  id: number;
...
export interface HomePageRwanda_AdminPanelLifeCycle {
  id: number;
  createdAt: Date;  updatedAt: Date;  publishedAt?: Date;  Hero?: Hero_Plain;
  Overview?: Overview_Plain;
  JoinTheTeam: Card_Plain[];
